...
public class PrgState {
    ...
    private MyISem semaphore;

    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIList<Value> ot, MyIFileTable file, MyIHeap heap,  IStmt prg, MyISem sem) {
        exeStack = stk;
        symTable = symtbl;
        output = ot;
