...
public class ProgramListController {
    ...
    private Controller ctr1, ctr2, ctr3, ctr4, ctr5, ctr6, ctr7, ctr8, ctr9, ctr10, ctr11;
    private IStmt ex1, ex2, ex3, ex4, ex5, ex6, ex7, ex8, ex9, ex10, ex11;
    ...
    public ProgramListController() {
        ...
        ctr1 = new Controller(new Repository(new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyFileTable(), new MyHeap(), ex1, new MySem()), "log1.txt"));
        ctr2 = new Controller(new Repository(new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyFileTable(), new MyHeap(), ex2, new MySem()), "log2.txt"));
        ctr3 = new Controller(new Repository(new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyFileTable(), new MyHeap(), ex3, new MySem()), "log3.txt"));
        ctr4 = new Controller(new Repository(new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyFileTable(), new MyHeap(), ex4, new MySem()), "log4.txt"));
        ctr5 = new Controller(new Repository(new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyFileTable(), new MyHeap(), ex5, new MySem()), "log5.txt"));
        ctr6 = new Controller(new Repository(new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyFileTable(), new MyHeap(), ex6, new MySem()), "log6.txt"));
        ctr7 = new Controller(new Repository(new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyFileTable(), new MyHeap(), ex7, new MySem()), "log7.txt"));
        ctr8 = new Controller(new Repository(new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyFileTable(), new MyHeap(), ex8, new MySem()), "log8.txt"));
        ctr9 = new Controller(new Repository(new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyFileTable(), new MyHeap(), ex9, new MySem()), "log9.txt"));
        ctr10 = new Controller(new Repository(new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyFileTable(), new MyHeap(), ex10, new MySem()), "log10.txt"));
        ctr11 = new Controller(new Repository(new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyFileTable(), new MyHeap(), ex11, new MySem()), "log11.txt"));
        try {
