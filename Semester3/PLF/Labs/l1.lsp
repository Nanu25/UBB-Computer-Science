...
;   )
; )
; (print (addElement '(1 2 3 4) 'x 2 0))
...
;                               l1 u collect-sublists(car l1) u collect-sublists(cdr l1) is l1 is list
;                               collect-sublists(cdr l1) otherwise;
...
;               0 if nrOcc(car l1, l1) != nrOcc(car l1, a) or nrOcc(car l2 l1) != nrOcc(car l2 l2)
...
;     ((/= (nrOcc (car l1) l1) (nrOcc (car l1) l2)) 0)
;     ((/= (nrOcc (car l2) l1) (nrOcc (car l2) l2)) 0)
;     (t (eqset (cdr l1) (cdr l2)))
;   )
; )

; (print (eqset '(1 2 3) '(3 2 1 10)))
