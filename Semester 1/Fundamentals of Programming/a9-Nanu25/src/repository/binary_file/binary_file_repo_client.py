...
class BinaryFileRepoClients:
    ...
    # clients = generate_random_clients(20)
    # repo_clients = MemoryRepository()
    # for client in clients:
    #     repo_clients.add(client)
    #
    #
    #
    # with open("clients_binary", "wb") as binary_file:
    #     pickle.dump(repo_clients.get_dict(), binary_file)
