...
class BinaryFileRepoRentals:
    ...
    # books, clients, rentals = generate_random_rentals(20)
    # repo_rentals = MemoryRepository()
    # for rental in rentals:
    #     repo_rentals.add(rental)
    #
    #
    #
    # with open("rentals_binary", "wb") as binary_file:
    #     pickle.dump(repo_rentals.get_dict(), binary_file)
