...
namespace Lab2SGDB
{
    public partial class Form1 : Form
    {
        ...
        private void buttonSelect_Click(object sender, EventArgs e)
        {
            try
            {
                // Get table name and select query from configuration
                ...
                // Create the command using the configured query
                ...
                // Clear the dataset and fill it with new data
                ds.Clear();
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Get IDs dynamically using column names from configuration
                int selectedChildId = Convert.ToInt32(dataGridView2.SelectedRows[0].Cells[childPrimaryKey].Value);
                int parentId = Convert.ToInt32(dataGridView2.SelectedRows[0].Cells[childForeignKey].Value);
                ...
                if (dr == DialogResult.Yes)
                {
                    ...
                    // Add parameter - use the correct parameter name from your delete query
